...
class _ProductCardState extends State<ProductCard> {
  ...
  Widget build(BuildContext context) {
    ...
    // print("이미지 개수 ${widget.imageUrl.length}");
    print("이미지 url ${widget.imageUrl}");
    return Container(
      ...
      child: Column(
        ...
        children: [
          if (widget.images.isNotEmpty)
            ClipRRect(
              ...
              child: ProductImageSlider(
                imageUrl:
                widget.images.map((e) => e.productImageUrl).toList(),
              ),
            ),
          ...
          dbImages = (widget.images ?? [])
        .where((e) => e.widget.images != null && e.widget.images!.isNotEmpty)
        .map((e) => e.e.widget.images!)
        .toList();
      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: ProductImageSlider(
              imageUrl: widget.images.isNotEmpty ? widget.images.map((e) => e.productImageUrl).toList() : [AccommodationImageUtils.getDefaultImagePath(widget.productId)],
            )
