...
class InfoSection extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          if (contactList.isEmpty)
            const IconTextRow(label: '연락처', value: "등록되지 않은 업체입니다.")
          else
  ...
  void _showContextMenu(BuildContext context, Offset offset, String number) async {
    final result = await showMenu<String>(
      ...
      items: [
        const PopupMenuItem(value: 'copy', child: ListTile(leading: Icon(Icons.copy), title: Text('복사하기'))),
        const PopupMenuItem(value: 'call', child: ListTile(leading: Icon(Icons.phone), title: Text('전화걸기'))),
      ],
    );
