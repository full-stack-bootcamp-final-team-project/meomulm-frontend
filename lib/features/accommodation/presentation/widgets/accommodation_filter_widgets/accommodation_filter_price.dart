...
class _AccommodationFilterPriceState extends State<AccommodationFilterPrice> {
  ...
  void _onTextChange() {
    ...
    if (min <= max && max <= 200) {
      context.read<AccommodationProvider>().setPrice(RangeValues(min, max));
    }
  }
      ...
      children: [
        ...
        SliderTheme(
          data: SliderThemeData(
            ...
            activeTickMarkColor: AppColors.onPressed,   // 선택된 범위 안의 점 색상
            inactiveTickMarkColor: AppColors.gray6,     // 선택되지 않은 범위의 점 색상
            // tickMarkShape: const RoundSliderTickMarkShape(
            //   tickMarkRadius: 0.0, // 점의 크기
            // ),
          ...
          children: [
            Expanded(
              child: TextField(
                ...
                textAlign: TextAlign.end, // 숫자는 오른쪽 정렬이 깔끔함
